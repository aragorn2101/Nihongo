...
/*  Cross-matching matrix to detect and replace exceptions  */
/*                           1  2  3  4  5  6  7  8  9   */
int cross_match[7][10] = {{  0,  0,  0,  0,  0,  0,  0,  0,  0 },    // 十
                          {  0,  0,  8,  0,  0,  9,  0, 10,  0 },    // 百
                          {  0,  0, 11,  0,  0,  0,  0, 12,  0 },    // 千
                          {  0,  0,  0,  0,  0,  0,  0,  0,  0 },    // 万
                          {  0,  0,  0,  0,  0,  0,  0,  0,  0 },    // 億
                          { 13,  0,  0,  0,  0,  0,  0, 14,  0 },    // 兆
                          { 18,  0,  0,  0,  0, 19, 20,  0,  0 } };  // 京
